...
object ApiModule {
    ...
    private const val LOCAL_API_BASE_URL = "http://filehost.feelsoftware.com/"
    ...
    @Provides
    @Singleton
    fun providesGitHackApi(retrofit: Retrofit): GitHackApi = retrofit.create(GitHackApi::class.java)
}